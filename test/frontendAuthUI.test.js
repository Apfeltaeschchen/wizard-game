...
assert.ok(html.includes('data-avatar="wizard_blue"'), 'wizard_blue vorhanden');
assert.ok(html.includes('data-avatar="wizard_green"'), 'wizard_green vorhanden');
assert.ok(html.includes('data-avatar="wizard_red"'), 'wizard_red vorhanden');
assert.ok(html.includes('data-avatar="wizard_yellow"'), 'wizard_yellow vorhanden');
...
console.log('✓ 2. Auth-Modal mit Magier-Auswahl (4 Avatare) verifiziert');
...
console.log('✓ 4. Leaderboard-Modal verifiziert');
...
assert.ok(js.includes('p.avatarId'), 'p.avatarId wird in UI gerendert');
